...
INSERT INTO plays_team (id, name, start_date) VALUES (3, 'Локомотив', '2014-09-14');
INSERT INTO plays_team (id, name, start_date) VALUES (4, 'Монта', null);
INSERT INTO plays_team (id, name, start_date) VALUES (5, 'Рапид', null);
INSERT INTO plays_team (id, name, start_date) VALUES (6, 'Спарта', null);
INSERT INTO plays_team (id, name, start_date) VALUES (7, 'Мозамбик', null);

INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (1, '2014-08-23', '13:47:10', 1, 2, 3, 1);
...
INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (3, '2014-09-20', '12:30:00', 1, 3, 0, 0);
INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (4, '2014-10-04', '13:40:00', 4, 1, 0, 0);
INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (5, '2014-10-11', '16:20:00', 1, 5, 0, 0);
INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (6, '2014-10-19', '19:50:00', 6, 1, 0, 0);
INSERT INTO plays_match (id, date, time, home_team_id, guest_team_id, home_team_score, guest_team_score) VALUES (7, '2014-09-28', '09:41:29', 1, 7, 4, 10);
...
INSERT INTO plays_person (id, first_name, last_name, position, is_active, is_captain, start_date, finish_date, cell_phone, email, team_id, user_id) VALUES (5, 'Демид', 'Сычев', 'H', 1, 0, '2014-09-13', '1992', '89123711249', '', 1, 3);
...
-- INSERT INTO plays_card (id, type, person_id, minute, match) VALUES (1, 'Y', 1, 24, 1);
...
INSERT INTO plays_person_matches_intended (id, person_id, match_id) VALUES (11, 1, 2);
INSERT INTO plays_person_matches_intended (id, person_id, match_id) VALUES (12, 1, 4);
INSERT INTO plays_person_matches_intended (id, person_id, match_id) VALUES (13, 1, 6);